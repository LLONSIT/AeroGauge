...
/* 6BB14 8006AF14 0C01B200 */  jal        osGetTime
...
/* 6BB98 8006AF98 0C01D058 */  jal        osSetTimer
/* 6BB9C 8006AF9C 01693823 */   subu      $a3, $t3, $t1
/* 6BBA0 8006AFA0 27A40028 */  addiu      $a0, $sp, 0x28
/* 6BBA4 8006AFA4 27A5006C */  addiu      $a1, $sp, 0x6C
/* 6BBA8 8006AFA8 0C019824 */  jal        osRecvMesg
/* 6BBAC 8006AFAC 24060001 */   addiu     $a2, $zero, 0x1
.L8006AFB0:
/* 6BBB0 8006AFB0 24180004 */  addiu      $t8, $zero, 0x4
/* 6BBB4 8006AFB4 3C01801B */  lui        $at, %hi(__osMaxControllers)
/* 6BBB8 8006AFB8 A038ABD1 */  sb         $t8, %lo(__osMaxControllers)($at)
/* 6BBBC 8006AFBC 0C01AC48 */  jal        __osPackRequestData
/* 6BBC0 8006AFC0 00002025 */   or        $a0, $zero, $zero
/* 6BBC4 8006AFC4 3C05801B */  lui        $a1, %hi(__osContPifRam)
/* 6BBC8 8006AFC8 24A5AB90 */  addiu      $a1, $a1, %lo(__osContPifRam)
/* 6BBCC 8006AFCC 0C01D090 */  jal        __osSiRawStartDma
...
/* 6BBE0 8006AFE0 0C019824 */  jal        osRecvMesg
/* 6BBE4 8006AFE4 24060001 */   addiu     $a2, $zero, 0x1
/* 6BBE8 8006AFE8 3C05801B */  lui        $a1, %hi(__osContPifRam)
/* 6BBEC 8006AFEC 24A5AB90 */  addiu      $a1, $a1, %lo(__osContPifRam)
/* 6BBF0 8006AFF0 0C01D090 */  jal        __osSiRawStartDma
...
/* 6BC04 8006B004 0C019824 */  jal        osRecvMesg
/* 6BC08 8006B008 24060001 */   addiu     $a2, $zero, 0x1
/* 6BC0C 8006B00C 8FA40074 */  lw         $a0, 0x74($sp)
/* 6BC10 8006B010 0C01AC14 */  jal        __osContGetInitData
/* 6BC14 8006B014 8FA50078 */   lw        $a1, 0x78($sp)
/* 6BC18 8006B018 3C01801B */  lui        $at, %hi(__osContLastCmd)
/* 6BC1C 8006B01C 0C01D028 */  jal        __osSiCreateAccessQueue
/* 6BC20 8006B020 A020ABD0 */   sb        $zero, %lo(__osContLastCmd)($at)
...
/* 6BC50 8006B050 3C0F801B */  lui        $t7, %hi(__osMaxControllers)
/* 6BC54 8006B054 91EFABD1 */  lbu        $t7, %lo(__osMaxControllers)($t7)
/* 6BC58 8006B058 27BDFFE8 */  addiu      $sp, $sp, -0x18
/* 6BC5C 8006B05C 3C0E801B */  lui        $t6, %hi(__osContPifRam)
/* 6BC60 8006B060 25CEAB90 */  addiu      $t6, $t6, %lo(__osContPifRam)
...
/* 6BCE8 8006B0E8 3C19801B */  lui        $t9, %hi(__osMaxControllers)
/* 6BCEC 8006B0EC 9339ABD1 */  lbu        $t9, %lo(__osMaxControllers)($t9)
...
/* 6BD34 8006B134 3C01801B */  lui        $at, %hi(__osContPifRam)
/* 6BD38 8006B138 000E7880 */  sll        $t7, $t6, 2
/* 6BD3C 8006B13C 002F0821 */  addu       $at, $at, $t7
/* 6BD40 8006B140 AC20AB90 */  sw         $zero, %lo(__osContPifRam)($at)
...
/* 6BD54 8006B154 3C19801B */  lui        $t9, %hi(__osMaxControllers)
/* 6BD58 8006B158 9339ABD1 */  lbu        $t9, %lo(__osMaxControllers)($t9)
/* 6BD5C 8006B15C 3C09801B */  lui        $t1, %hi(__osContPifRam)
/* 6BD60 8006B160 24080001 */  addiu      $t0, $zero, 0x1
/* 6BD64 8006B164 3C01801B */  lui        $at, %hi(D_801AABCC)
/* 6BD68 8006B168 2529AB90 */  addiu      $t1, $t1, %lo(__osContPifRam)
...
/* 6BDC4 8006B1C4 3C18801B */  lui        $t8, %hi(__osMaxControllers)
...
/* 6BDE0 8006B1E0 9318ABD1 */  lbu        $t8, %lo(__osMaxControllers)($t8)

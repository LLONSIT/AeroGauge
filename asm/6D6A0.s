...
/* 6D6C8 8006CAC8 3C188009 */  lui        $t8, %hi(D_80094C54)
/* 6D6CC 8006CACC 8F184C54 */  lw         $t8, %lo(D_80094C54)($t8)
...
/* 6D6EC 8006CAEC 3C0B8009 */  lui        $t3, %hi(D_80094C54)
/* 6D6F0 8006CAF0 8D6B4C54 */  lw         $t3, %lo(D_80094C54)($t3)
...
/* 6D714 8006CB14 3C198009 */  lui        $t9, %hi(D_80094C54)
/* 6D718 8006CB18 8F394C54 */  lw         $t9, %lo(D_80094C54)($t9)
...
/* 6D738 8006CB38 3C0C8009 */  lui        $t4, %hi(D_80094C54)
/* 6D73C 8006CB3C 8D8C4C54 */  lw         $t4, %lo(D_80094C54)($t4)
...
/* 6D760 8006CB60 3C088009 */  lui        $t0, %hi(D_80094C54)
/* 6D764 8006CB64 8D084C54 */  lw         $t0, %lo(D_80094C54)($t0)
...
/* 6D784 8006CB84 3C0D8009 */  lui        $t5, %hi(D_80094C54)
/* 6D788 8006CB88 8DAD4C54 */  lw         $t5, %lo(D_80094C54)($t5)
...
/* 6D7AC 8006CBAC 3C188009 */  lui        $t8, %hi(D_80094C54)
/* 6D7B0 8006CBB0 8F184C54 */  lw         $t8, %lo(D_80094C54)($t8)
/* 6D7B4 8006CBB4 3C010001 */  lui        $at, (0x10000 >> 16)
/* 6D7B8 8006CBB8 3C098009 */  lui        $t1, %hi(D_80094C54)
/* 6D7BC 8006CBBC 8F19000C */  lw         $t9, 0xC($t8)
/* 6D7C0 8006CBC0 03214025 */  or         $t0, $t9, $at
/* 6D7C4 8006CBC4 AF08000C */  sw         $t0, 0xC($t8)
/* 6D7C8 8006CBC8 8D294C54 */  lw         $t1, %lo(D_80094C54)($t1)
...
/* 6D7EC 8006CBEC 3C0E8009 */  lui        $t6, %hi(D_80094C54)
/* 6D7F0 8006CBF0 8DCE4C54 */  lw         $t6, %lo(D_80094C54)($t6)
...
/* 6D800 8006CC00 3C088009 */  lui        $t0, %hi(D_80094C54)
/* 6D804 8006CC04 01E1C824 */  and        $t9, $t7, $at
/* 6D808 8006CC08 ADD9000C */  sw         $t9, 0xC($t6)
/* 6D80C 8006CC0C 8D084C54 */  lw         $t0, %lo(D_80094C54)($t0)
...
.L8006CC28:
/* 6D828 8006CC28 3C0D8009 */  lui        $t5, %hi(D_80094C54)
/* 6D82C 8006CC2C 8DAD4C54 */  lw         $t5, %lo(D_80094C54)($t5)
